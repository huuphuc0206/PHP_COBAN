    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 style="color:  rgb(31, 146, 146);" class="page-title">QUẢN LÝ LOẠI SẢN PHẨM</h4>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input style="margin-top:1vw;" type="text" class="form-control" id="ten" placeholder="Nhập vào id..." name="ten">
                                    </div>
                                </div>
                                <div class="form-group row">
