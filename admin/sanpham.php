    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 style="color:  rgb(31, 146, 146);" class="page-title">DANH SÁCH SẢN PHẨM</h4>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 style="font-size: 18px;" class="card-title">Thông tin sản phẩm</h5>
        ...
        ?>
            ...
            ?>
                <tr>
                    ...
                    <td><a href="sanpham-edit.php?id=<?= $sanpham['id_sanpham'] ?>">Sửa</a></td>
